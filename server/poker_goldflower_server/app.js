...
var config = configs.game_server_poker_goldflower()[server_index];
...
db.init(configs.mysql(), logger, 'POKER GOLDFLOWER');
logdb.init(configs.mysqllog(),log_logger)
log_manager.init(log_logger,'POKER GOLDFLOWER');
http.init(log_http,'POKER GOLDFLOWER');
