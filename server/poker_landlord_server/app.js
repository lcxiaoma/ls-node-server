...
var config = configs.game_server_poker_landlord()[server_index];
...
db.init(configs.mysql(), logger, 'POKER LANDLORD');
logdb.init(configs.mysqllog(),log_logger)
log_manager.init(log_logger,'POKER LANDLORD');
http.init(log_http,'POKER LANDLORD');
