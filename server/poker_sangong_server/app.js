...
var config = configs.game_server_poker_sangong()[server_index];
...
db.init(configs.mysql(), logger, 'POKER SANGONG');
logdb.init(configs.mysqllog(),log_logger)
log_manager.init(log_logger,'POKER SANGONG');
http.init(log_http,'POKER SANGONG');
