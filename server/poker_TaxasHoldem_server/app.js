...
var config = configs.game_server_poker_taxas()[server_index];
...
db.init(configs.mysql(), logger, 'POKER TAXAS');
logdb.init(configs.mysqllog(),log_logger)
log_manager.init(log_logger,'POKER TAXAS');
http.init(log_http,'POKER TAXAS');
